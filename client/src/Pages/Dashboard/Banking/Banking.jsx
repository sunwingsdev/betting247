...
import { useAddMotherAdminBalanceMutation } from "../../../redux/features/allApis/usersApi/usersApi";
...
const Banking = () => {
  ...
  const handleAddBalance = async () => {
    if (user?.role === "mother-admin") {
      ...
      if (result?.error) return toast.error(result.data.error.message);
      ...
      toast.error("Login as a mother admin");
    }
  };
