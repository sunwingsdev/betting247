...
import RegistrationModal from "../Home/RegistrationModal/RegistrationModal";
...
const TopHeader = ({ settingOpen, setSettingOpen }) => {
  ...
  return (
    <>
      ...
      <DynamicModal isOpen={isOpen} closeModal={() => setIsOpen(false)}>
        <RegistrationModal closeModal={() => setIsOpen(false)} />
      </DynamicModal>
    </>
  );
};
